const compute = (
  ...
  const severeCasesByRequestedTime = Math.trunc((15 / 100) * infectionsByRequestedTime); // Both
  ...
  const casesForICUByRequestedTime = Math.trunc((5 / 100) * infectionsByRequestedTime); // Both
